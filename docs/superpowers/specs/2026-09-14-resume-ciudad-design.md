...
| Derrumbe | La rampa al agua va de x 274 a 286 (su labio bajo llega al agua en toda la manzana), la plataforma de `paving` va de 286 a 304, y los tres bloques hundidos están en el agua sin cruzarse; el cuarto bloque cayó en la calle frente al malecón (`FALLEN_BLOCK` en `city-grid.ts`, única fuente para el derrumbe, los autos y el test) |
